...
print('1. Unique numbers:', len(unique_number_plates))

# ==== 2 ====
if input_number in number_plates:
    print('2. Entered number is on the list')
else:
    print('2. Your number is not on the list')

# ==== 3 ====
input_numbers_only = input_number[2:6]
sum_of_numbers = 0

for number in input_numbers_only:
    sum_of_numbers += int(number)

print('3. Sum of the numbers in the entered number: ', sum_of_numbers)